...
\caption{UML dijagram obrasca za projektovanje "Posmatrač".\protect\footfootmark}
\label{fig:UMLObserver}
\end{figure}

\footnotetext{Preuzeto sa \url{https://sourcemaking.com/design_patterns/observer}}
...
\begin{figure}[h!]
    ...
    \caption{UML dijagram obrasca za projektovanje "Posetilac".\protect\footnotemark} 
    \label{fig:UMLVisitor}
\end{figure}

\footnotetext{Preuzeto sa \url{https://sourcemaking.com/design_patterns/visitor}}
