...
\begin{itemize}
    \item Komponenta koja pruža klase za rad sa opštom AST apstrakcijom
    \item Komponenta za semantičko poređenje opštih AST --- konzolni izlaz
    \item Komponenta za vizualizaciju --- grafički prikaz AST
    \item Korisnički interfejs --- glavni program koji omogućava generisanje, prikaz, serijalizaciju i poređenje AST
\end{itemize}
...
\input{chapters/61_impl_myast.tex}
\input{chapters/62_impl_comparer.tex}
\input{chapters/63_impl_visualizer.tex}
\input{chapters/64_impl_ui.tex}
\input{chapters/64_impl_tests.tex}
